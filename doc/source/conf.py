...
author = 'Ansible Lockdown Contributors'
category = 'Security'
copyright = '2018, Ansible Lockdown Contributors'
description = 'Applies DISA STIG RHEL 7 Hardening Guidnace to Systems'
...
oslosphinx_cgit_link = (
    'https://github.com/MindPointGroup/{}'.format(target_name)
)
